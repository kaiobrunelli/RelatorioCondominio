...
import { LucideBuilding2, LucideCheck, LucideDroplets, LucideLock } from '@lucide/angular';
...
@Component({
  ...
  imports: [FormsModule, Card, PageHeader, LucideBuilding2, LucideCheck, LucideDroplets, LucideLock],
